...
namespace DbDataAccess
{
    ...
    public partial class sampleDBEntities : DbContext
    {
        ...
        public virtual int spGetEmployee(Nullable<int> id)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spGetEmployee", idParameter);
        }
    
        public virtual int spGetStudentByID(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spGetStudentByID", iDParameter);
        }
